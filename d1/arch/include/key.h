...
// synthesised - the menus turning a gamepad button into a keypress - can build
// one on the stack and hand it straight to a handler, rather than pushing it
// back through event_send() and re-entering the event loop from inside a
// handler.
